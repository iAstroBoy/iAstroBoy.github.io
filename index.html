  ...
  <div id="site-wrap">
    ...
    <div id="form">
      <div id="subscribe">
        <div class="tb-cell">
		<center><u>
          <p class="animation section-subtitle">Anna sucks confirmed.</u></p>
          <p class="section-title">MapleEuphoria</h2></center>
          <!-- subscribe form -->
          ...
          <div class="section-cell">
            <div class="container">
              ...
              <div class="section-header row text-center">
                <div class="col-xs-12">
                  <p class="animation section-subtitle">Be ready, we are launching soon.</p>
                  <h1 class="section-title">
                    <span class="section-title-span">Euphoria v83</span>
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
                          ...
                          <div class="countdown-period days_ref">Home</div>
						  </a> 
                        </div>
                      </div>
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
						  ...
						  <a href="#forum">
                          <div class="countdown-period hours_ref">Forum</div>
						  </a> 
                        </div>
                      </div>
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
						  ...
						  <a href="#discord">
                          <div class="countdown-period minutes_ref">Discord</div>
						 </a>
                        </div>
                      </div>
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
						  ...
						  <a href="#vote">
                          <div class="countdown-period seconds_ref">Vote</div>
						  </a>
                        </div>
                      </div>
                    </div>
    ...
    <footer id="site-footer">
      ...
      <a href="#" id="volume">
        ...
        <span></span>
	  	 ...
	  	 <center> © 2017 MapleEuphoria </center>
<center> All images and other content related to MapleStory are owned by the Nexon Corporation. </center>
