              ...
              <div class="section-header row text-center">
                <div class="col-xs-12">
                  ...
                  <h1 class="section-title">
                    <span class="section-title-span">Horizon v83</span>
                    ...
                    <div class="row">
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
                          ...
                          <div class="countdown-period days_ref">Register</div>
						  </a> 
                        </div>
                      </div>
                      <div class="col-xs-3 col-countdown">
                      ...
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
                          ...
                          <div class="countdown-period minutes_ref">LIT</div>
                        </div>
                      </div>
                      <div class="col-xs-3 col-countdown">
                        <div class="countdown-section">
                          <div class="countdown-amount seconds"></div>
                          <div class="countdown-period seconds_ref">AF</div>
                        </div>
                      </div>
                    </div>
                  </div>
